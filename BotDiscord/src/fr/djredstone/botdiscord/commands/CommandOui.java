...
public class CommandOui {
	...
	public CommandOui(@Nullable String option, @Nullable GuildMessageReceivedEvent event1, @Nullable SlashCommandEvent event2) {
		...
		String message = "";
		if(event2 != null) {
			if(event2.getOption("oui_message") != null) message = event2.getOption("oui_message").getAsString();
		} else {
