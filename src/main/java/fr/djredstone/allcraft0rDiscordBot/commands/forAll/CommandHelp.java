...
public class CommandHelp {
	...
	private static final ArrayList<String> names = new ArrayList<>(Arrays.asList("utils", "fun", "economy", "staff"));
	...
	public CommandHelp(String arg, @Nullable MessageReceivedEvent event1, @Nullable SlashCommandInteractionEvent event2) {
		...
		if (names.contains(arg.toLowerCase())) {
			...
			UtilsCommands.replyOrSend("Aucun argument donné (`utils` | `fun` | `economy` | `staff`)", event1, event2);
		}
